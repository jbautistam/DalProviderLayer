...
namespace Bau.Libraries.LibDBProvidersBase.Parameters
{
	...
	{ 
		...
		///		Añade un parámetro a la colección de parámetros del comando
		/// </summary>
		public void Add(string strName, object objValue, ParameterDirection intDirection = ParameterDirection.Input)
		{ if (objValue is Enum)
				Add(new ParameterDB(strName, (int) objValue, intDirection));
			else
